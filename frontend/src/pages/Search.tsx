...
const Search = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-[250px_minmax(0,1fr)] max-w-6xl mx-auto p-4">
      <div className="self-start rounded-lg border border-slate-300 p-5 h-fit lg:sticky lg:top-10">
